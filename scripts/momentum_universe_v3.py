...
# Broader Indian large-cap universe
TICKERS = [
...
def run_strategy(monthly_prices, monthly_returns, bench_monthly, top_n):
...
def main():
    print("Downloading broader universe data...")
    ...
    dq.to_csv(OUTPUT_DIR / "momentum_v3_data_quality.csv", index=False)
    summary_df.to_csv(OUTPUT_DIR / "momentum_v3_summary.csv", index=False)
    returns_out.to_csv(OUTPUT_DIR / "momentum_v3_monthly_returns.csv", index=False)
    holdings_out.to_csv(OUTPUT_DIR / "momentum_v3_holdings.csv", index=False)
    equity_out.to_csv(OUTPUT_DIR / "momentum_v3_equity_curves.csv", index=False)

    print("\nMomentum Universe V3 Summary")
    print("-" * 28)
    ...
    print("\nSaved files")
    print("-" * 11)
    print("outputs/momentum_v3_data_quality.csv")
    print("outputs/momentum_v3_summary.csv")
    print("outputs/momentum_v3_monthly_returns.csv")
    print("outputs/momentum_v3_holdings.csv")
    print("outputs/momentum_v3_equity_curves.csv")
